...
export declare function initRepo(workDir: string, repoUrl: string, corsProxyUrl: string): Promise<GitController>;
export declare function setRepoUrl(configWindow: WindowOpenerParams): Promise<string>;
